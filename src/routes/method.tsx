        ...
        <div className="mt-5 grid gap-5 sm:grid-cols-3">
          {[
            ...
            },
            {
              ...
              tag: '分指数',
              title: '不是每个指数都适用',
              body: '实测下来：创业板指、中证500 的深跌信号很有效；沪深300、中证A500 只有 200 日口径有效、60 日口径跑不赢常态；纳斯达克100 两个口径都没有优势；新加的恒生指数两个口径都经得起分段检验，但日经225 与恒生科技的超额只出现在近半段样本里（用前半段标定会直接标不出水位）。所以水位按指数逐个标定，没有超额的就不给。',
            },
          ].map((c) => (
