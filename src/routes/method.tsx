      ...
      <Card className="p-6 sm:p-7">
        ...
        <dl className="mt-5 grid gap-x-10 gap-y-4 text-[12.5px] sm:grid-cols-2">
          {[
            [
              '数据源',
              '按市场分两个源，都是免费、无需密钥的公开接口：美股走 Yahoo Finance chart API；A 股走东方财富 push2his 日线接口（klt=101 日线、fqt=1 前复权）。之所以不能共用一个源：Yahoo 对 A 股指数基本是「有代码无历史」—— 沪深300 只从 2021 年起、创业板指完全没有数据。',
            ],
            [
              '覆盖标的',
              '6 个指数。美股 2 个：标普500（^GSPC，数据自 1950 年）、纳斯达克100（^NDX，自 1985 年）；A 股 4 个：沪深300（000300）、中证A500（000510）、中证500（000905）、创业板指（399006），A 股宽基数据均可回溯到 2005 年前后。',
            ],
            [
              '回溯段（重要）',
